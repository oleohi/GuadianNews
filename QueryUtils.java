...
import static com.example.guadiannews.NewsActivity.LOG_TAG;
...
public class QueryUtils {
    ...
    /**
     * Query the GuardianNews dataset and return a list of {@link News} objects.
     * This method glues all the other helper methods together into one single call.
     */
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> news = getNews(jsonResponse);

        Log.v("Fetch news data", "getNews successful");
     ...
     */
    private static List<News> getNews(String newsJson) {
